        ...
        <table class="table table-bordered table-sm mt-5">
            ...
            <?php foreach($coletas as $coleta): ?>
                <tr>
                    ...
                    <td><a data-toggle="modal" data-target="#coletasModal" class="editar_coleta" data-coleta="<?=$coleta->ID?>"> Editar</a> - <a href="<?=base_url('coletas/excluir/'.$coleta->ID)?>">Excluir</a></td>               
                </tr>
            <?php endforeach;?>
        </table>
    </div>       
